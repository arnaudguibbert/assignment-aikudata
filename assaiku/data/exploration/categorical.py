...
def compute_dist(
    ...
    cross_tab = compute_contigency_tab(
        data=data, cat_col=cat_col, label_col=label_col, weight_col=weight_col
    )
...
def visualize_distance(
    ...
    for col in categorical_cols:
        ...
        dist_distance = wasserstein_distance(
            u_values=support,
            v_values=support,
            u_weights=dist[pos_lab],
            v_weights=dist[neg_lab],
        ) / len(support)
